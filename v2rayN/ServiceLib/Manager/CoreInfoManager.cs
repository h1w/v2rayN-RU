            ...
            new CoreInfo
                {
                    ...
                    DownloadUrlWin64 = urlN + "/download/{0}/v2rayN-RU-windows-64.zip",
                    DownloadUrlWinArm64 = urlN + "/download/{0}/v2rayN-RU-windows-arm64.zip",
                    DownloadUrlLinux64 = urlN + "/download/{0}/v2rayN-RU-linux-64.zip",
                    DownloadUrlLinuxArm64 = urlN + "/download/{0}/v2rayN-RU-linux-arm64.zip",
                    DownloadUrlLinuxRiscV64 = urlN + "/download/{0}/v2rayN-RU-linux-riscv64.zip",
                    DownloadUrlLinuxLoong64 = urlN + "/download/{0}/v2rayN-RU-linux-loong64.zip",
                    DownloadUrlOSX64 = urlN + "/download/{0}/v2rayN-RU-macos-64.zip",
                    DownloadUrlOSXArm64 = urlN + "/download/{0}/v2rayN-RU-macos-arm64.zip",
                },
